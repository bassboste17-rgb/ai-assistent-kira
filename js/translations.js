...
const translations = {
  ...
  "admin.form.includes":      { ru: "Что включено (через запятую)", en: "What's included (comma separated)", ka: "რა შედის (მ��იმით გამოყავით)" },
  ...
  "admin.form.photos":        { ru: "Фотографии (загрузка на ImgBB)", en: "Photos (upload to ImgBB)", ka: "ფო��ოები (აიტვირთება ImgBB-ზე)" },
  ...
  "terms.s6.p1":         { ru: "DAMQ Travel не несёт ответственности за задержки или изменения, вызванные обстоятельствами вне нашего контроля (погода, перекрытия дорог и т.п.). Мы сделаем всё возможное, чтобы помочь.", en: "DAMQ Travel is not responsible for delays or changes caused by circumstances beyond our control (weather, road closures, etc.). We will do our best to assist.", ka: "DAMQ Travel არ არის პასუხისმგებელი იმ დაგვიანებებზე ან ცვლილებებზე, რომლებიც გამოწვეულია ჩვენი კონტროლის მიღმა არსებული მიზეზებით (ამინდი, გზების ჩაკეტვა და ა.შ.). ჩვენ გავა��ეთებთ მაქსიმუმს, რომ დაგეხმაროთ." },
  ...
  "detail.duration":      { ru: "Длител��ность",         en: "Duration",           ka: "ხანგრძლივობა" },
  ...
  "blog.article3.desc":   { ru: "Как провести два дня в столице Грузии с максимальной пользой — от старого города до современных кварта��ов.", en: "How to spend two days in the capital of Georgia most effectively — from the old town to modern districts.", ka: "როგორ გაატაროთ ორი დღე საქართველოს დედაქალაქში მაქსიმალური სარგებლით — ძველი ქალაქიდან თანამედროვე კვარტლებამდე." },
...
// -- SEASON PAGES --
  ...
  "season.winter.highlights.subtitle": { ru: "Зима в Грузии — это горнолыжные курорты мирового класса, целебные источники и праздничная атмосфера", en: "Winter in Georgia offers world-class ski resorts, healing springs and festive atmosphere", ka: "ზამთარი საქართველოში — მსოფლიო დონის სათხილამურო კურორტე��ი, სამკურნალო წყაროები და სადღესასწაულო ატმოსფერო" },
